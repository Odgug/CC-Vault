...
public class VaultReaderBlock extends BaseEntityBlock{
    ...
    public void onRemove(BlockState pState, Level pLevel, BlockPos pPos, BlockState pNewState, boolean pIsMoving) {
        if (pState.getBlock() != pNewState.getBlock()) {
            ...
            if (blockEntity instanceof VaultReaderBlockEntity) {
                ((VaultReaderBlockEntity) blockEntity).drops();
            }
        }
    ...
    public InteractionResult use(BlockState pState, Level pLevel, BlockPos pPos,
        ...
        if (!pLevel.isClientSide()) {
            ...
            if(entity instanceof VaultReaderBlockEntity) {
                NetworkHooks.openGui(((ServerPlayer)pPlayer), (VaultReaderBlockEntity)entity, pPos);
            } else {
